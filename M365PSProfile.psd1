...
- Changed: Multiple Modules will be uninstalled after 5 seconds delay with User Warning (Resolves: https://github.com/fabrisodotps1/M365PSProfile/issues/26)
- Added: KeepMultipleVersions switch to Install-M365Module to keep multiple Versions of Modules installed (Resolves: https://github.com/fabrisodotps1/M365PSProfile/issues/26)
...
- Updated the PSResourceGet dependency to version 1.2.0 to support the new features and improvements in PSResourceGet (Resolves: https://github.com/fabrisodotps1/M365PSProfile/issues/25)
